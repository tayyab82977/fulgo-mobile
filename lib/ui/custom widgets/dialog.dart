...
static  double CalcPackagePrice({String? senderCity, String? deliverCity, ResourcesData? resourcesData, String? weightId, String? packagingId}) {
    double total;
    double weightPrice;
    ...
    if (senderCity == deliverCity) {
      ...
      // }
      var weightPriceDouble =
      double.parse(resourcesData!.priceOutside);
      weightPrice = weightPriceDouble;
      var packagingPriceDouble ;
      for (int i = 0; i < resourcesData.packaging!.length; i++) {
        if (packagingId == resourcesData.packaging![i].id) {
  ...
  static Future<Packages> CreateShipmentDialog (BuildContext context , ErCity senderCity , ErCity receiverCity , Neighborhoods senderZone ,  Neighborhoods receiverZone , double width , double height , Packages? editedPackage , String? selectedPackaging )async{
  ...
  //fill the data for the edit package
    ...
    if(editedPackage != null ){
              ...
              _quantityController.text = editedPackage.quantity ?? "" ;
               codCheckedValue = editedPackage.cod != null && editedPackage.cod != '0' && editedPackage.cod != '' ? true : false ;
               for(int i = 0 ; i < SavedData.resourcesData.packaging!.length ; i++){
                 if(editedPackage.packaging == SavedData.resourcesData.packaging![i].id){
        ...
        if(selectedPackaging != null){
          ...
          try {
            switch (selectedPackaging) {
              ...
              case "liquid":
                {
                  _currentSelectedPackaging = SavedData.resourcesData.packaging![1];
                }
                break;
              case "frozen":
                {
                  _currentSelectedPackaging = SavedData.resourcesData.packaging![2];
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: checkedValue ? Constants.blueColor : Colors.grey)
                                  ),
                                  child:Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            Text('fragile'.tr(),
                                              style: TextStyle(
                                                  fontSize: width*0.03,
                                                  color:checkedValue ?  Constants.blueColor:Colors.grey
                                              ),
                                            ),
                                          ],
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: SvgPicture.asset(
                                          ...
                                          width: 25,
                                          height: 25,
                                          color: checkedValue ? null : Colors.grey,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("(Taxes Included)".tr() , style: TextStyle(
                                    fontSize: 9
                                ),),
                                ...
                                setState2(() {
                                  ...
                                  Packages myNewPackage = Packages(
                                    ...
                                    _packageCommentController
                                        .text ,
                                    cod: _codController.text.isEmpty ? '' : _codController.text,
                                    price: price,
                                  );
