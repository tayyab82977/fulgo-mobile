...
import 'package:Fulgox/ui/Client/DetailedOrder.dart';
import 'package:Fulgox/ui/custom widgets/custom_button.dart';
...
class _OrdersCardState extends State<OrdersCard> {
  ...
  Widget build(BuildContext context) {
    ...
    width = size.width;
    height = size.height;
    return CreateOrderCard(loading: false);
  }
            ...
            children: [
                  ...
                  widget.showStatus != null
                      ? Padding(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: widget.ordersDataModel?.trackType == '5' ||
                                      widget.ordersDataModel?.trackType == '16'
                                  ? Color(0xFF56D340)
                                  : widget.ordersDataModel?.trackType == '14' ||
                      ...
                      : Padding(
                          ...
                          child: Column(
                            children: [
                                                  ...
                                                  onPressed: () {
                                                    if (Platform.isAndroid) {
                                                      Downloader.downloadPDFAndroid2(
                                                          widget.taskId,
                                                          "https://portal.Fulgox.com/print_invoice/${widget.ordersDataModel?.id}",
                                              ...
                                              CustomButton(
                                                  ...
                                                  onPressed: () {
                                                    if (Platform.isAndroid) {
                                                      Downloader.downloadPDFAndroid2(
                                                          widget.taskId,
                                                          "https://portal.Fulgox.com/print_invoices/${widget.ordersDataModel?.id}",
                                                          widget.ordersDataModel
                                                                  ?.id ??
                                                              "");
                                                    } else {
                                              ...
                                              CustomButton(
                                                  ...
                                                  onPressed: () {
                                                    if (Platform.isAndroid) {
                                                      Downloader.downloadPDFAndroid2(
                                                          widget.taskId,
                                                          "https://portal.Fulgox.com/print_invoices2/${widget.ordersDataModel?.id}",
                                                          widget.ordersDataModel
                                                                  ?.id ??
                                                              "");
                                                    } else {
                              ...
                              (widget.ordersDataModel?.followup?.isNotEmpty ??
                                          false) &&
                                      (widget.ordersDataModel?.followup !=
                                          "0") &&
                                      widget.ordersDataModel?.followup !=
                                          widget.ordersDataModel?.id
                                  ? Padding(
                              ...
                              widget.ordersDataModel?.trackType == "4"
                                  ? Padding(
                                      ...
                                      child: GestureDetector(
                                          ...
                                          child: Image.asset(
                                            'assets/images/live_tracking.png',
                                            height: 30,
                                          )),
                                    )
                                  : SizedBox()
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      '${widget.ordersDataModel?.stamp!.substring(0, 11)}',
