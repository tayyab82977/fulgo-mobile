...
import 'package:xturbox/ui/courier/captainEditShipment.dart';
...
class _OrdersCardState extends State<CapOrdersCard> {
  ...
  idToNames() {
    ...
    for (int i = 0 ; i < (widget.resourcesData?.packaging?.length ?? 0 ) ; i++) {
      if (widget.ordersDataModel?.packaging == widget.resourcesData?.packaging?[i].id) {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              widget.cancel == null ? GestureDetector(
                                onTap:(){
                                  setState(() {
                          ...
                          widget.ordersDataModel?.cod != '' &&
                            ...
                            children: [
                              Text(
                                'Cash on delivery'.tr(),
                                style:
                                TextStyle(color: Constants.capOrange),
                              ),
                              SizedBox(
                                width: 2,
                              ),
                            ...
                            Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    ...
                                    style: TextStyle(color: Color(0xff851e23)),
                                  ),
                                )),
                          ],
                        )
                ...
                // ExpansionTile(
                //   backgroundColor: Constants.capPurple,
