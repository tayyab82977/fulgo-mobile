...
import 'package:Fulgox/ui/Client/ofd_orders_dialog.dart';
...
class _NewHomeScreenState extends State<NewHomeScreen> {
  ...
  List<String> imageList = [
    "https://portal.Fulgox.com/Tq8zYcZfaWVvMn2dseecigHqwQqwerT3/Fulgo3.png",
    "https://portal.Fulgox.com/Tq8zYcZfaWVvMn2dseecigHqwQqwerT1/Fulgo1.png",
    "https://portal.Fulgox.com/Tq8zYcZfaWVvMn2dseecigHqwQqwerT2/Fulgo2.png",
  ];
      ...
      if (deepLink != null) {
        ...
        if (deepLink.path.contains("/myPayments")) {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => ClientPaymentsScreen()));
        }
      }
    }, onError: (error) async {
      print(error);
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      _deliveryBtnElement(
                          "PackageDelivery".tr(), "assets/images/CARTON.png",
                          () {
                      ...
                      _deliveryBtnElement("Honey and oil oliveTransport".tr(),
                      ...
                      _deliveryBtnElement("RefrigeratedTransport".tr(),
                          "assets/images/refrigerated.png", () {
                        if (SavedData.profileDataModel.permission == "1") {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //       borderRadius: BorderRadius.circular(25),
                //       child: CachedNetworkImage(
                //         imageUrl: "https://portal.Fulgox.com/Tq8zYcZfaWVvMn2dseecigHqwQqwerT/Fulgo.png",
