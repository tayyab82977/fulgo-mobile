...
import 'package:Fulgox/ui/Client/eWallet_screen.dart';
...
import 'package:Fulgox/ui/dialogs/addAccount_dilog.dart';
import 'package:Fulgox/ui/dialogs/confirmation_dialog.dart';
import 'package:Fulgox/ui/dialogs/logOut_confirm.dart';
import 'package:Fulgox/ui/dialogs/switchAccount_dialog.dart';
...
class _MoreScreenState extends State<MoreScreen> {
  ...
  final DrawerClientController _drawerClientController =
      Get.put(DrawerClientController());
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (_drawerClientController.errorMessage.value.isNotEmpty) {
        WidgetsBinding.instance?.addPostFrameCallback((_) {
                                      ...
                                      Flexible(
                                        ...
                                        child: ListView(
                                          ...
                                          children: [
                                            ...
                                            _moreElement("Transfer to wallet",
                                                "wallet-transfer.svg", () {
                                              Navigator.push(
                                                  context,
                                                  MaterialPageRoute(
        ...
        builder: (context) {
          return SolidBottomSheet(
            ...
            body: Container(
              color: Colors.white,
              child: ListView(
                children: SavedData.accountsList
                    .map((e) => Material(
                          color: Colors.white,
                          child: CupertinoActionSheetAction(
                              child: InkWell(
                                onTap: () {
                                  if (SavedData.profileDataModel.phone !=
                                      e.phone)
                                    _switchAccountDialog(
                                        context, e.name, e.phone, e.password);
                                },
                                child: Row(
                                  mainAxisAlignment:
  ...
  _switchAccountDialog(
      BuildContext context, String name, String phone, String password) {
    showDialog(
        context: context,
        barrierDismissible: true,
        builder: (context) {
