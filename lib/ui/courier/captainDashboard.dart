...
class CaptainDashboardView extends StatefulWidget {
  ResourcesData? resourcesData;

  CaptainDashboardView({this.resourcesData});

  @override
  _CaptainDashboardViewState createState() => _CaptainDashboardViewState();
}

class _CaptainDashboardViewState extends State<CaptainDashboardView>
    with TickerProviderStateMixin {
  GlobalKey<RefreshIndicatorState>? refreshKeyHome;

  double? screenWidth, screenHeight;
  final CaptainOrdersController _controller =
      Get.put(CaptainOrdersController());

  Future<Null>? onRefreshAll() {
    editingControllerToStore.clear();
    editingControllerFromStore.clear();
    _controller.fetchCaptainOrders();
    return null;
  }
                      ...
                      Obx(() {
                        ...
                        if (_controller.errorMessage.value != '') {
                          WidgetsBinding.instance?.addPostFrameCallback((_) {
                            String error = _controller.errorMessage.value;
                        ...
                        if (_controller.captainOrdersData.value != null ||
                            _controller.isEmpty.value) {
                          return CreateMyReservesScreen(
                            loading: false,
                            captainOrdersData:
                                _controller.captainOrdersData.value,
                          );
                        }
  ...
  Widget CreateMyReservesScreen(
      {required bool loading, NewForCapOrders? captainOrdersData}) {
    ...
    if (captainOrdersData != null) {
      totalToStore = captainOrdersData.fromSore!.length.toString();
      totalFromStore = captainOrdersData.toStore!.length.toString();
    }
    return Column(
      children: [
        Padding(
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: RefreshIndicator(
                          ...
                          child: captainOrdersData?.fromSore != null &&
                                  captainOrdersData!.fromSore!.length > 0
                              ? ListView.builder(
                                  itemCount: captainOrdersData.fromSore!.length,
                                  itemBuilder: (context, i) {
                                    return NamesAndOrdersCard(
                                      captainOrdersController: _controller,
                                      resourcesData: widget.resourcesData,
                                      capOrdersList:
                                          captainOrdersData.fromSore![i],
                                      hasAction: true,
                                      reserved: false,
                                      print: false,
                                    );
                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: RefreshIndicator(
                                  ...
                                  child: captainOrdersData?.toStore != null &&
                                          captainOrdersData!.toStore!.length > 0
                                      ? ListView.builder(
                                          itemCount:
                                              captainOrdersData.toStore!.length,
                                          itemBuilder: (context, i) {
                                            return NamesAndOrdersCard(
                                              captainOrdersController:
                                                  _controller,
                                              resourcesData:
                                                  widget.resourcesData,
                                              capOrdersList:
                                                  captainOrdersData.toStore![i],
                                              hasAction: false,
                                              reserved: true,
                                              print: true,
                                              dashboardDataModel:
