...
class Downloader {
  ...
  static downloadPDFAndroid(
      String? taskId, OrdersDataModelMix? ordersDataModelMix) async {
  ...
  static downloadPDFAndroid2(
      String? taskId, String url, String fileName) async {
    _localPath = (await _findLocalPath()) + Platform.pathSeparator + 'Download';
  ...
  static void bindBackgroundIsolate(
      OrdersDataModelMix? ordersDataModelMix, BuildContext context) {
