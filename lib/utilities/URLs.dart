class URL {
  ...
  static const String LIVE_SERVER = "https://portal.xturbox.com/api/mobile/";
  ...
  // static const String Old_Server = "http://172.20.10.4/xTurboAPI/";
  static const List<String> serverLists = [
    LIVE_SERVER
  ];
